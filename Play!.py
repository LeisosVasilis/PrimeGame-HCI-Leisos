...
pygame.display.set_caption("HCI-Leisos-Prime_Game")


background = pygame.Surface((480, 480))
backimg = pygame.image.load(os.path.join("images", "back.jpg"))
...
pygame.mixer.music.load("lakehouse.mp3")
pygame.mixer.music.play(-1)



f = pygame.font.Font("freesansbold.otf", 16)
